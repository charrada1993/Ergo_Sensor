...
AI Engine: LightGBM Regressor + Condition Classifier (Optuna HPO, TimeSeriesSplit CV)
            + Severity Classifier + 5× Per-Joint Anomaly
...
class ReportGenerator:
    ...
    def _section_cover(self, df, stats):
        ...
        story.append(Paragraph(
            ...
            'and the Ergo Sensor AI Engine v3.0-Production (LightGBM) '
    ...
    def _section_ai_insights(self, stats, ai_df):
        S = self._styles
        story = [Spacer(1, 0.5 * cm),
                 SectionHeader('3. AI PREDICTIVE INSIGHTS (LightGBM)', bg=C_NAVY),
                 Spacer(1, 0.3 * cm)]
    ...
    def _section_clinical_recommendations(self, stats):
        ...
        story.append(Paragraph(
            ...
            '(AI Engine v3.0-Production — LightGBM, 75 features, Optuna HPO, '
