...
\section{Modélisation avec LightGBM}
Le modèle LightGBM prédit le risque de blessure à 10 jours avec une grande précision grâce à l'optimisation des hyperparamètres.
